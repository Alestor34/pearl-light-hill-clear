//#region node_modules/.nitro/vite/services/ssr/assets/defaults-LosX1biD.js
var DEFAULT_CONTENT = [
	{
		key: "brand.name",
		value: "نازلی",
	...
	{
		key: "hero.kicker",
		value: "مهمونی‌ش با شما",
		kind: "text"
	},
	{
		key: "hero.title",
		value: "خوشمزه‌هاش با ما",
		kind: "text"
	},
	{
		key: "hero.subtitle",
		value: "سینی مزه، فینگرفود و پک تولد برای مهمانی‌های تهران. تازه همان‌روز، مرتب روی سینی، رأس ساعت روی میز شما.",
		kind: "longtext"
	},
	{
		key: "hero.cta",
		value: "ثبت سفارش در واتساپ",
		kind: "text"
	},
	{
		key: "hero.cta2",
	...
	{
		key: "hero.badge",
		value: "ارسال در تهران",
		kind: "text"
	},
	{
		key: "marquee.text",
		value: "مینی برگر · مینی پیتزا · بورک · سمبوسه · رول یوفکا · ناگت · الویه · کشک بادمجان · سینی میوه · پک تولد",
		kind: "text"
	},
	{
		key: "feature.1.title",
	...
	{
		key: "menu.title",
		value: "از لقمه‌های کوچک تا سینی کامل",
		kind: "text"
	},
	{
		key: "menu.subtitle",
	...
	{
		key: "about.title",
		value: "یک آشپزخانهٔ خانگی، سینی‌های مهمانی",
		kind: "text"
	},
	{
		key: "about.body",
		value: "نازلی فینگر فود برای تولد، دورهمی و میز مزه در تهران کار می‌کند. مینی‌برگر، بورک، سمبوسه، الویه و سینی میوه را همان روز می‌پزیم و روی سینی چوبی یا ظرف مزه می‌چینیم. سفارش از ۴۸ ساعت قبل؛ جزئیات را در واتساپ یا با یک تماس هماهنگ می‌کنیم.",
		kind: "longtext"
	},
	{
		key: "about.image",
		value: "/food/about.jpg",
		kind: "image"
	},
	{
		key: "order.kicker",
	...
	{
		key: "contact.hours",
		value: "پاسخگویی هر روز از ۱۰ صبح تا ۱۰ شب",
		kind: "text"
	},
	{
		key: "contact.city",
...
var CONTENT_MODULES = [
	{
		...
		fields: [
			...
			{
				key: "brand.logo",
				label: "لوگو (خالی = نوشتهٔ گرافیکی)",
				kind: "image"
			},
			{
				key: "nav.menu",
	...
	},
	{
		...
		fields: [
			...
			{
				key: "popup.title",
				label: "عنوان پاپ‌آپ تعطیلی",
				kind: "text"
			},
			{
				key: "wa.prefill",
				label: "متن پیش‌فرض واتساپ",
				kind: "longtext"
			}
		]
	}
...
var DEFAULT_PRODUCTS = [
	...
	},
	{
		categorySlug: "packs",
		name: "پک ۱۶ نفره",
		description: "مینی برگر، رول یوفکا، مینی پیتزا، توپک، پیراشکی، راتا، رز پپرونی و بورک. سیرکننده برای دورهمی.",
		price: 103e5,
		unit: "یک پک",
		image: "/food/party-pack.jpg",
	...
	},
	{
		categorySlug: "packs",
		name: "پک ۳۵ نفره",
		description: "رول تست، بورک گوشت، فیله سوخاری، مینی هات‌داگ، مینی برگر، مینی ژامبون و کیک مرغ. مناسب وعدهٔ اصلی.",
		price: 135e5,
		unit: "یک پک",
		image: "/food/party-pack.jpg",
		badge: "",
...
//#endregion
export { DEFAULT_PRODUCTS as i, DEFAULT_CATEGORIES as n, DEFAULT_CONTENT as r, CONTENT_MODULES as t };
