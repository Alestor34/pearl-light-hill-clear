...
import { a as fetchPublicSite } from "./api-DVDfD253.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import { r as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BpL8n9Ca.js
...
function Toaster$1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		dir: "rtl",
		toastOptions: { classNames: { toast: "font-[Vazirmatn] bg-card text-ink border-line" } }
	});
}
var styles_default = "/assets/styles-DQKlKS-Z.css";
...
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "فینگرفود، سینی مزه و پک مهمانی نازلی در تهران"
			}
		],
		links: [
			{
...
var $$splitComponentImporter$1 = () => import("./routes-wcX2IzSI.mjs");
...
function Pending() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: "در حال چیدن سینی…"
	});
}
var $$splitComponentImporter = () => import("./admin-DwlwVtL4.mjs");
