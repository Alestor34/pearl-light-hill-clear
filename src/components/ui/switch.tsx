...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-slot="switch"
      className={cn(
        "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border border-ink/10 transition-colors",
        "data-[state=checked]:bg-herb data-[state=unchecked]:bg-cream-3",
